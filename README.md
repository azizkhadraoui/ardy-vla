...
|---|---|---|---|---|
| `ardy_vla.py` | — | Shared library: data, tokenizer, denoiser, samplers (CFG / inpainting / guidance), FK, projection, open-loop metrics, closed-loop LIBERO runner. Every script imports it so training and both evaluators share one definition of everything. | — | — |
